...
#include "ctest.h"
 ...
 {
     const int result = Cash(60, 60);
     const int expected = 241.500000;
     ASSERT_EQUAL(expected, result);
 }
CTEST(Test_Faild, Failtest01)
{
  const int result = Cash(137,317);
